...
//  Project-8-seven-little-words-game
//
//  Created by Kevin Cuadros on 18/08/24.
//
...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            var splitLabel = answersLabel.text?.components(separatedBy: "\n")
            splitLabel?[solutionPosition] = answerText
            answersLabel.text = splitLabel?.joined(separator: "\n")
            
            numberOfCorrect += 1
            score += 1
            currentAnswer.text = ""
            
            if numberOfCorrect % 7 == 0 {
                showAlert()
            }
            ...
            let ac = UIAlertController(
                title: "Failed",
                message: "Failed to find the guess",
